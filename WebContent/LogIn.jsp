    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin1">
                ...
                <button class="btn btn-lg btn-block btn-signin" type="submit" onClick="return signUp();">Sign up</button>
                <button class="btn btn-lg btn-block btn-signin" type="submit" onClick="return Guest();">Continue as Guest</button>
            </form><!-- /form -->
        </div><!-- /card-container -->
    </div><!-- /container -->